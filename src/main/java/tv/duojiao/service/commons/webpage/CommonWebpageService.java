package tv.duojiao.service.commons.webpage;
...
public class CommonWebpageService {
     ...
     * @return
     */
    public ResultListBundle<RecommendEnity> searchByGame(String query, String gameName, String category, int size, int page) {
